...
const Testimonials = () => {
  return (
    <div className="overflow-hidden bg-brandBlack">
      <Container className="relative py-10 maxwidthContainer">
        <div className="w-3/4 lg:w-1/2 mb-6 sm:mb-10 md:mb-16">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl text-white font-semibold">
            We develop long-term partnership with our client through building open and effective communication and trust
          </h2>
        </div>
            ...
            <div className="flex h-auto" key={idx}>
              <div className="flex flex-col bg-white rounded-xl dark:bg-slate-900">
                <div className="flex-auto p-4 md:p-6">
                  <p className="text-base italic md:text-lg text-gray-800 dark:text-gray-200">&quot;{card.test}&quot;</p>
                </div>
                ...
                <div className="p-4 bg-gray-100 rounded-b-xl md:px-7 dark:bg-slate-700">
                  <div className="flex items-center">
                    <div className="flex-shrink-0">
                      <Image
                        className="size-8 rounded-full sm:h-[2.875rem] sm:w-[2.875rem] object-cover"
                        src={card.img}
                        width={400}
                        height={400}
                    ...
                    <div className="grow ms-3">
                                  <p className="text-sm sm:text-base font-semibold text-gray-800 dark:text-gray-200">{ card.name}</p>
                                  <p className="text-xs text-gray-500 dark:text-gray-400">{ card.position}</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="mt-20 grid gap-6 grid-cols-2 sm:gap-12 lg:grid-cols-3 lg:gap-8">
          ...
          <div>
            ...
            <p className="mt-1 text-gray-400">partner with RollinsCodes</p>
          </div>
